...
```
cd existing_repo
git remote add origin https://hub.mos.ru/good177yy/sentiment-analyzer.git
git branch -M main
...
- [ ] [Настройте интеграцию](https://hub.mos.ru/good177yy/sentiment-analyzer/-/settings/integrations)
